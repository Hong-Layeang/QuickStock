    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 dark:hover:text-red-400 rounded-xl transition-all duration-200 hover:cursor-pointer"
        >
  ...
  return (
    <>
      ...
      <button
        ...
        className={`lg:hidden fixed top-4 left-4 z-40 p-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-500 hover:cursor-pointer
      ...
      <div className={`lg:hidden fixed inset-0 z-50 transition-opacity duration-300 ${
        ...
        />
        <div
          className={`absolute left-0 top-0 h-full w-80 max-w-[85vw] bg-white dark:bg-gray-900 shadow-2xl transform transition-transform duration-300 ease-in-out ${
