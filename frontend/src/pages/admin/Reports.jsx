            ...
            <table className={`min-w-full text-xs sm:text-sm ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>
              <thead>
                <tr className={isDark ? 'bg-gray-700' : 'bg-gray-100'}>
                  <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium">Date</th>
                  <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium">Supplier</th>
                  <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium">Product</th>
                  <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium">Qty</th>
                  <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-medium">Price</th>
                ...
                {filteredReports.length === 0 ? (
                  ...
                  filteredReports.map((report) => (
                    <tr key={report.id} className={`border-t ${isDark ? 'hover:bg-gray-700 border-gray-600' : 'hover:bg-orange-50 border-gray-200'}`}>
                      ...
                      <td className="px-2 sm:px-4 py-2 sm:py-3">
                        <div className="text-xs sm:text-sm font-medium truncate max-w-24 sm:max-w-32">
                          {report.supplierName || 'Unknown'}
                        </div>
                      </td>
                      <td className="px-2 sm:px-4 py-2 sm:py-3">
                        <div className="text-xs sm:text-sm truncate max-w-24 sm:max-w-32">
                      ...
                      <td className="px-2 sm:px-4 py-2 sm:py-3">
                        <span className={`inline-block px-1 sm:px-2 py-1 rounded text-xs font-medium ${
