...
export default function Reports() {
  ...
  const { reports, loading, error, fetchSupplierReports } = useReportStore();
  ...
  // Filtered and sorted reports: newest first (matches admin logic)
      ...
      <div className={`rounded-2xl p-6 shadow-md border ${
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
          <div className="flex-1">
            ...
            <p className={`text-sm sm:text-base ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>Track your sales performance and history.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-3 sm:gap-4 mt-4 mb-6">
